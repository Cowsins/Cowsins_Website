  ...
  return (
    ...
    <Modal isOpen={isOpen} onOpenChange={onOpenChange} backdrop="blur">
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">Offline Documentation</ModalHeader>
              <ModalBody>
                <p> You can find the documentation for this package in the included files.
                </p>
                <p className="opacity-50">
                Public online documentation for this package is currently being developed and will be available soon.
                </p>
        ...
        <div className="hidden md:flex justify-start">
            ...
            <DropdownSection title="Unity" showDivider>  
              <DropdownItem
                ...
                >
                <Link color="foreground" showAnchorIcon isExternal href={siteConfig.links.fpsengine}>
                FPS Engine
                 </Link>
              ...
              <DropdownItem
                ...
                >
                    <Link color="foreground" showAnchorIcon isExternal href={siteConfig.links.cowsinai}>
                   Cowsins AI
                 </Link>
          ...
          <Dropdown>
            ...
            <DropdownSection title="Unity" showDivider>  
              <DropdownItem
                ...
                <DropdownItem
                  key="bullethellengine"   onPress={onOpen}  
                >
                  Bullet Hell Engine
                </DropdownItem>
              </DropdownSection>
          ...
          <Dropdown>
            ...
            <DropdownSection title="Unity" showDivider>  
              ...
              <DropdownItem
                  ...
                  description="Created by Comrad Elmo"
                >
                     <Link color="foreground" showAnchorIcon isExternal href={siteConfig.links.cowsinsaitutorial}>
                     Cowsins AI
                 </Link>
          ...
          <Dropdown>
            ...
            <DropdownItem
                ...
                >
                  <Link color="foreground" showAnchorIcon isExternal href={siteConfig.links.discord}>
                  Discord
                 </Link>
                ...
                >
                  ...
                  <Link color="foreground" showAnchorIcon isExternal href="mailto:cowsinsgames@gmail.com">
                  Email
                 </Link>
