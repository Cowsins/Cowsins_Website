...
export const siteConfig = {
  name: "Cowsins",
  description: "Make your Dream Game With Award Winning Game Development Assets.",
  navItems: [
    {
      label: "Home",
      href: "/",
   ...
   links: {
    ...
    fpsengine: "https://assetstore.unity.com/packages/templates/systems/fps-engine-218594",
